            ...
            for(let a=0;a<index.GetFlowSpeed();a++)
            {
                ...
                {	
                    if(interactionCheck(blocks[(i+a)+z*cols],blocks[(i+1+a)+z*cols],1,0,i,z,a,0)==true){}
                        ...
                        let x=edsLIB.getRandomInt(0,index.GetFlowChance());
                        if(x==0){
...
{
    let rand=edsLIB.getRandomInt(0,1); 
    if(rand==1)
    {
        ...
        if(iD1>9&&iD1<12){//changes fire
            ...
            let rand2=edsLIB.getRandomInt(0,10);
...
window.physics={physics,GetBlocks,WipeBlocks};
})()
